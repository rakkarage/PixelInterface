...
func _ready() -> void:
	_colorEdit.connect("text_changed", self, "_colorEditChanged")
	_colorPicker.connect("color_changed", self, "_colorPickerChanged")
	_seedSlider.share(_seedEdit)
	_seedEdit.connect("value_changed", self, "_seedEditChanged")
	_seedSlider.connect("value_changed", self, "_seedSliderChanged")
	_octavesSlider.share(_octavesEdit)
	_octavesEdit.connect("value_changed", self, "_octavesEditChanged")
	_octavesSlider.connect("value_changed", self, "_octavesSliderChanged")
	_periodSlider.share(_periodEdit)
	_periodEdit.connect("value_changed", self, "_periodEditChanged")
	_periodSlider.connect("value_changed", self, "_periodSliderChanged")
	_persistenceSlider.share(_persistenceEdit)
	_persistenceEdit.connect("value_changed", self, "_persistenceEditChanged")
	_persistenceSlider.connect("value_changed", self, "_persistenceSliderChanged")
	_lacunaritySlider.share(_lacunarityEdit)
	_lacunarityEdit.connect("value_changed", self, "_lacunarityEditChanged")
	_lacunaritySlider.connect("value_changed", self, "_lacunaritySliderChanged")
	_generateButton.connect("pressed", self, "_generatePressed")
	_resetButton.connect("pressed", self, "_resetPressed")
	_saveButton.connect("pressed", self, "_savePressed")
